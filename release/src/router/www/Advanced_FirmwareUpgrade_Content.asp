...
download_url_redir = "https://fw.alfky.my.id/asuswrt-merlin/updates/" + based_modelid;
download_url = "https://fw.alfky.my.id/asuswrt-merlin";
...
function show_fw_release_note(event) {
	...
	if (event.data.isMerlin) {
		...
		if (event.data.product_id)
			siteurl = "https://fw.alfky.my.id/asuswrt-merlin/updates/" + event.data.product_id;
		else
		...
		<tr>
		  ...
		  <div class="formfontdesc"><strong><#FW_note#></strong>
				<ol>
					...
					<li id="fw_note3">Get the latest firmware version from the download site at <a style="font-weight: bolder;text-decoration: underline;color:#FFFFFF;" href="https://fw.alfky.my.id/asuswrt-merlin" target="_blank">https://fw.alfky.my.id/asuswrt-merlin</a></li>
