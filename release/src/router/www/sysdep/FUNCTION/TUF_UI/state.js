...
//		banner_code +='<iframe width="0" height="0" frameborder="0" scrolling="no" src="/manifest.asp"></iframe>';
	...
	if(rog_support){
		...
		banner_code +='<div style="margin-top:0px;margin-left:-90px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#Web_Title2#></span></div>';
			// logout
		banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 15px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#t1Logout#></div></div></a>\n';
	}
